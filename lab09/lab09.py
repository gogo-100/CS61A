...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            print(f"'Please update your balance with ${self.price - self.balance} more funds.'")
        elif self.balance == self.price:
            print(f"'Here is your {self.product}.'")
            self.stock -= 1
            self.balance = 0
        else:
            print(f"'Here is your candy and ${self.balance - self.price} change.'")
            self.stock -= 1
            self.balance = 0
...
def reverse_other(t):
    ...
    def reverse_odd_depth_tree(t,deep):
        if deep % 2 == 1:
            i = 0
            j = len(t.branches) - 1
            while i < j:
        ...
        for tree in t.branches:
            reverse_odd_depth_tree(tree,deep+1)

    reverse_odd_depth_tree(t,1)
