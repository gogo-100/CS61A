...
def balanced(m):
    ...
    if is_mobile(m):
        ...
        return torque_left == torque_right and balanced(left(m)) and balanced(right(m))
    elif is_arm(m):
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t) and label(t) == 'loki':
        ...
        return tree(label(t),[replace_loki_at_leaf(subtree,lokis_replacement)for subtree in branches(t)])
...
def has_path(t, word):
    ...
    if len(word) == 1:
        ...
        return label(t) == word[0] and any(has_path(subtree,word[1:]) for subtree in branches(t))
